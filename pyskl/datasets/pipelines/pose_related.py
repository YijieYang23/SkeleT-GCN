...
class JointToBone:
    ...
    def __init__(self, dataset='nturgb+d', target='keypoint'):
        ...
        self.target = target
        if self.dataset not in ['nturgb+d', 'openpose', 'coco', 'handmp', 'coco-wholebody', 'expressive-keypoints']:
            raise ValueError(
        ...
        if self.dataset == 'nturgb+d':
            ...
            self.pairs = ((0, 0), (1, 0), (2, 1), (3, 2), (4, 3), (5, 0), (6, 5), (7, 6), (8, 7), (9, 0), (10, 9),
                          ...
                          (20, 19))
        elif self.dataset.startswith('coco-wholebody'):
            assert self.dataset in ['coco-wholebody', 'expressive-keypoints']
            body_bones = ((0, 0), (1, 0), (2, 0), (3, 1), (4, 2), (5, 0), (6, 0), (7, 5), (8, 6), (9, 7), (10, 8),
                          (11, 0), (12, 0), (13, 11), (14, 12), (15, 13), (16, 14))
            feet_bones = tuple([(i - 1, j - 1) for (i, j) in [
                (18, 20), (19, 20), (20, 16),
                (21, 23), (22, 23), (23, 17)
            ]])
            face_bones = tuple([(i - 1, j - 1) for (i, j) in [
                (24, 41), (25, 24), (26, 25), (27, 26), (28, 27), (29, 28),
                (30, 29), (31, 30), (32, 31), (33, 32), (34, 33), (35, 34), (36, 35), (37, 36), (38, 37), (39, 38),
                (40, 39), (41, 42), (42, 43), (43, 44), (44, 45), (45, 46), (46, 47), (47, 48), (48, 49), (49, 50),
                (50, 40), (51, 52), (52, 53), (53, 54), (54, 1), (55, 56), (56, 57), (57, 54), (58, 57), (59, 58),
                (60, 61), (61, 62), (62, 63), (63, 64), (64, 65), (65, 60), (66, 67), (67, 68), (68, 69), (69, 70),
                (70, 71), (71, 66), (72, 73), (73, 74), (74, 75), (75, 76), (76, 77), (77, 78), (78, 79), (79, 80),
                (80, 81), (81, 82), (82, 83), (83, 72), (84, 85), (85, 86), (86, 87), (87, 88), (88, 89), (89, 90),
                (90, 91), (91, 84)
            ]])
            hands_bones = tuple([(i - 1, j - 1) for (i, j) in [
                (92, 10), (93, 92), (94, 93), (95, 94), (96, 95), (97, 92), (98, 97), (99, 98), (100, 99), (101, 92),
                (102, 101), (103, 102), (104, 103), (105, 92), (106, 105), (107, 106), (108, 107), (109, 92),
                (110, 109), (111, 110), (112, 111), (113, 11), (114, 113), (115, 114), (116, 115), (117, 116),
                (118, 113), (119, 118), (120, 119), (121, 120), (122, 113), (123, 122), (124, 123), (125, 124),
                (126, 113), (127, 126), (128, 127), (129, 128), (130, 113), (131, 130), (132, 131), (133, 132)
            ]])

            if self.dataset == 'coco-wholebody':
                self.pairs = body_bones + feet_bones + face_bones + hands_bones
            elif self.dataset == 'expressive-keypoints':
                face_index = range(23, 91)
                bones = body_bones + feet_bones + hands_bones
                self.pairs = tuple([
